<template>
  <div class="home">
    <div class="hero">
<svg width="845" height="173" viewBox="0 0 845 173" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M82.9001 0.519989V25.72H26.2001V55.78H75.3401V80.98H26.2001V133H0.100098V0.519989H82.9001Z" fill="#F65C8A"/>
<path d="M90.5628 92.68C90.5628 84.64 92.4228 77.44 96.1428 71.08C99.9827 64.72 105.323 59.74 112.163 56.14C119.123 52.42 126.983 50.56 135.743 50.56C144.503 50.56 152.183 52.42 158.783 56.14C165.503 59.74 170.663 64.72 174.263 71.08C177.863 77.44 179.663 84.64 179.663 92.68C179.663 100.72 177.863 107.98 174.263 114.46C170.663 120.94 165.503 126.04 158.783 129.76C152.183 133.36 144.383 135.16 135.383 135.16C126.623 135.16 118.823 133.48 111.983 130.12C105.263 126.64 99.9827 121.72 96.1428 115.36C92.4228 109 90.5628 101.44 90.5628 92.68ZM115.943 92.86C115.943 99.1 117.743 104.32 121.343 108.52C124.943 112.6 129.503 114.64 135.023 114.64C140.783 114.64 145.403 112.6 148.883 108.52C152.483 104.44 154.283 99.22 154.283 92.86C154.283 86.5 152.483 81.28 148.883 77.2C145.403 73.12 140.783 71.08 135.023 71.08C129.503 71.08 124.943 73.18 121.343 77.38C117.743 81.46 115.943 86.62 115.943 92.86Z" fill="#F65C8A"/>
...
<path d="M418.818 0.519989V25.72H362.118V55.78H411.258V80.98H362.118V133H336.018V0.519989H418.818Z" fill="#F65C8A"/>
...
<path d="M338 -234.5C338 -17.7283 162.496 158 -54 158C-270.496 158 -331 114.772 -331 -102C-331 -318.772 -319.996 -424 -103.5 -424C86 -327 338 -451.272 338 -234.5Z" fill="#5F5CF6"/>
</g>
<g filter="url(#filter1_f)" class="logo-motion">
<path d="M912.5 -127C912.5 16.8702 823.955 149 647.5 149C471.045 149 328 32.3702 328 -111.5C328 -255.37 455 -111.5 647.5 -271C823.955 -271 912.5 -270.87 912.5 -127Z" fill="#00B5FF"/>
</g>
</g>
<defs>
<filter id="filter0_f" x="-411" y="-504" width="829" height="742" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
<feFlood flood-opacity="0" result="BackgroundImageFix"/>
<feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
<feGaussianBlur stdDeviation="40" result="effect1_foregroundBlur"/>
</filter>
<filter id="filter1_f" x="248" y="-351" width="744.5" height="580" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
<feFlood flood-opacity="0" result="BackgroundImageFix"/>
<feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
<feGaussianBlur stdDeviation="40" result="effect1_foregroundBlur"/>
</filter>
